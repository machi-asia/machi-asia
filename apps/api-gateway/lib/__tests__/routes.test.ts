import { getRoutes, resetRoutes, resolveRoute } from "@/lib/routes";
import { assertRegistryConsistent, RESERVED_PREFIXES, SERVICE_REGISTRY, ServiceDefinition } from "@/lib/services";
